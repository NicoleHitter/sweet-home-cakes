...
### Strategy
#### Targeted Users
* A user that wants to buy a cake from Sweet Home Cakes who could be an old or a new user of any age group that prefers to use an online easy purchase system. 
...
![LucidchartDiagram](/static/doc/wireframes/RBStructureDiagram.png)
...
# Manual Testing 
## Responsiveness
Nicoles Sweet Home project looks and works on different browsers and screen sizes. Manual testing was conducted for responsiveness on small, medium and large screens. 
On submission of the forms we get confirmation message and confirmation email. Toasts appear when making any changes to your bag.
